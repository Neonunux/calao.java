...
public class EarTrainingPanel extends JPanel implements ActionListener 
{
	...
	/**
	 * Instantiates a new ear training panel.
	 *
	 * @param f the f
	 * @param b the b
	 * @param p the p
	...
	public EarTrainingPanel(Font f, ResourceBundle b, Preferences p, MidiController mc, Dimension d)
	{
		...
		sBar = new SmartBar(new Dimension(d.width, sBarHeight), b, f, p, true, true, false);
	...
	/**
	 * Gets the label from index.
	 *
	 * @param idx the idx
	 * @return the label from index
	 */
	 ...
	 * @param fromPiano the from piano
	 */
	...
	/**
	 * The Class EarTrainingGameThread.
	 */
