...
public class MidiOptionsDialog extends JDialog implements ActionListener
{
	...
	public MidiOptionsDialog(ResourceBundle b, Preferences p, MidiController midiCtrl, AudioInputController audioCtrl)
	{
        ...
        setLayout(null);
		setIconImage(new ImageIcon(getClass().getResource("midi.png")).getImage());
		...
		audioTestButton.setIcon(new ImageIcon(getClass().getResource("microphone.png")));
        ...
        cancelButton.setIcon(new ImageIcon(getClass().getResource("wrong.png")));
