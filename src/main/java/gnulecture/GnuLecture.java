...
public class GnuLecture extends JFrame implements ActionListener 
{
	 ...
	 public GnuLecture() 
	 {
		 ...
		 if ("he".equals(language) || "hu".equals(language) || "ru".equals(language) || "eo".equals(language))
		 {
			try 
			{
				bundle = new PropertyResourceBundle(new InputStreamReader(getClass().getResourceAsStream("gnulecture.lang.language_" + language + ".properties"), "UTF-8"));
			} 
			catch (IOException e) 
			{ 
			...
			bundle = ResourceBundle.getBundle("gnulecture.lang.language", new Locale(language));
		}
