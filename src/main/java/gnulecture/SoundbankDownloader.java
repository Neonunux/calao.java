...
{
	static final Logger logger = (Logger) LogManager.getLogger(SoundbankDownloader.class.getName());
	...
	public void startDownload()
	{
		try
		{
			BufferedInputStream in = new java.io.BufferedInputStream(
					new URL("https://github.com/Neonunux/gnulecture/wiki/extras/soundbank-mid.gm").openStream());
